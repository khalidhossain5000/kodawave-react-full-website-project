      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500">
              ...
              <li><Link to="/services" className="hover:text-black transition-colors">Software Architecture</Link></li>
              <li><Link to="/services" className="hover:text-black transition-colors">Digital Strategy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500">
              <li className="flex items-center gap-3 hover:text-black transition-colors cursor-pointer">
                <FaDiscord /> Discord
              </li>
              <li className="flex items-center gap-3 hover:text-black transition-colors cursor-pointer">
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            ...
            <div className="p-2 bg-indigo-600 group-hover:bg-indigo-700 text-white rounded-lg transition-colors">
              <FaArrowUp size={14} />
            </div>
          </button>
        </div>
